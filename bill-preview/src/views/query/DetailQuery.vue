      ...
      <div class="filter-bar">
        <lay-space :size="16">
          <lay-input 
            ...
            style="width: 200px"
          />
          <lay-select v-model="filters.account" placeholder="选择账户" size="small" style="width: 150px">
          ...
          <lay-select v-model="filters.type" placeholder="交易类型" size="small" style="width: 120px">
